...
<body onload="initView()">
    ...
    <div class="clearfix">
        ...
        <div class="side">
            <div class="dataRow"><label for="signal">CAN Signal: <output type="text" id="signal">2000</output></div>
            <div class="dataRow"><label for="dac">DAC Output: <output type="text" id="dac">204</output></div>
            <div class="dataRow"><label for="frame">CAN Frame</label></div>
            <div>
                <table id='frame'>
                    <tr>
                        <th></th>

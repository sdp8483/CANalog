...
#define SPI_DELAY_us        5           /* delay for uS before each SPI.transmit to allow STM32 time to catch up, STM32 needs a few uS between bytes */
#define SPI_BAUD            1000000UL   /* SPI clock baud rate in Mbits/sec */
